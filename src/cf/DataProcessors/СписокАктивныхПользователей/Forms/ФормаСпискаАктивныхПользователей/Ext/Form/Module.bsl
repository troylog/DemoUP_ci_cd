...
Процедура ЗаполнитьСписок()
	...
	Если ТекущийСеанс <> Неопределено Тогда
		...
		Если НайденныеСеансы.Количество() = 1 Тогда
			...
			Элементы.СписокПользователей.ВыделенныеСтроки.Очистить();Элементы.СписокПользователей.ВыделенныеСтроки.Добавить(Элементы.СписокПользователей.ТекущаяСтрока);
		КонецЕсли;
	КонецЕсли;  
